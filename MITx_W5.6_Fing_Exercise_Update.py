'''
Write the code for the update method using the docstring
'''
import random
...
class Hand(object):
    ...
    def update(self, word):
        ...
        for l in word:
            if l not in new_hand.keys() or new_hand == 0:
                return False
            else:
                new_hand -= 1
        self.hand = new_hand
    ...
    def update_grader_answer(self, word):
        """
        Answer to the update exercise from the grader.
        """
